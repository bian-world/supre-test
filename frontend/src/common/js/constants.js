...
export const API_SCENARIO_LIST = 'api_scenariapi_scenario_listo_list'
export const UI_PAGE_LIST = 'ui_page_list'
export const UI_AUTOMATION_LIST = 'ui_automation_list'
...
export const SUB_PROJECT_ID = 'sub_project_id';
export const SUB_PROJECT_NAME = 'sub_project_name';
...
export const MOCKJS_FUNC = [
  ...
  {name: '@color', des: i18n.t('api_test.request.color'), ex: "#6ca2e9"},
...
export const ORIGIN_COLOR = '#FFFFFF'; // '#2c2a48'
export const ORIGIN_COLOR_SHALLOW = '#2666c6'; //'#595591'
export const COUNT_NUMBER = '#007fff'; //'#314a7c'
export const COUNT_NUMBER_SHALLOW ='#9EBEEE';   //'#9ebeee'
export const PRIMARY_COLOR = '#2666c6';
