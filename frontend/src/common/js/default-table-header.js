...
//接口定义
  API_DEFINITION: [
    ...
    {id: 'method', key: '2', label: 'api_test.definition.api_type'},
    {id: 'path', key: '3', label: 'api_test.definition.api_path'},
    {id: 'name', key: '4', label: 'api_test.definition.api_name'},
    {id: 'subProjectName', key: '5', label: 'api_test.definition.api_name'},
    {id: 'userName', key: '6', label: 'api_test.definition.api_principal'},
    ...
    {id: 'caseTotal', key: '9', label: 'api_test.definition.api_case_number'},
    {id: 'caseStatus', key: '10', label: 'api_test.definition.api_case_status'},
...
//接口用例
  API_CASE: [
    ...
    {id: 'subProjectName', key: '4', label: 'api_test.definition.api_definition_path'},
  ...
  API_SCENARIO: [
    ...
    {id: 'subProjectName', key: '3', label: 'api_report.scenario_name'},
    {id: 'level', key: '4', label: 'api_test.automation.case_level'},
    {id: 'status', key: '5', label: 'test_track.plan.plan_status'},
    {id: 'tags', key: '6', label: 'commons.tag'},
    {id: 'versionId', key: 'f', label: 'project.version.name', xpack: true},
    {id: 'creatorName', key: 'd', label: 'api_test.automation.creator'},
    {id: 'principalName', key: 'g', label: 'api_test.definition.api_principal'},
  ...
  TEST_CASE_REVIEW: [
    ...
    {id: 'projectName', key: '3', label: '所属产品'},
    {id: 'subProjectName', key: '4', label: 'test_track.review.review_project'},
    {id: 'creatorName', key: '5', label: 'test_track.review.review_creator'},
  ...
  TEST_PLAN_LIST: [
    ...
    {id: 'subProjectName', key: '7', label: 'test_track.plan.plan_project'},
    ...
    {id: 'actualStartTime', key: '10', label: 'test_track.plan.actual_start_time'},
  ...
  TRACK_TEST_CASE: [
    ...
    {id: 'versionId', key: 'b', label: 'project.version.name', xpack: true},
    {id: 'subProjectName', key: '5', label: '所属项目'},
    {id: 'nodePath', key: '6', label: 'test_track.case.module'},
    {id: 'updateTime', key: '7', label: 'commons.update_time'},
    {id: 'createName', key: '8', label: 'commons.create_user'},
    {id: 'createTime', key: '9', label: 'commons.create_time'},
    {id: 'desc', key: '10', label: 'test_track.case.case_desc'},
  ...
  UI_PAGE: [
    {id: 'num', key: '1', label: "ID"},
    {id: 'name', key: '2', label: 'ui.ui_page'},
    {id: 'subProjectName', key: '3', label: 'report.project_name'},
    {id: 'elementTotal', key: '4', label: 'ui.element_total'},
    {id: 'pagePath', key: '5', label: 'ui.page_level'},
  ...
  UI_AUTOMATION: [
    {id: 'num', key: '1', label: "ID"},
    // {id: 'preScenarioName', key: '2', label: 'ui.pre_case'},
    {id: 'name', key: '3', label: 'ui.case_name'},
    {id: 'subProjectName', key: '4', label: 'report.project_name'},
    {id: 'modulePath', key: '5', label: 'ui.func_name'},
    {id: 'stepTotal', key: '6', label: 'ui.step_total'},
    {id: 'creatorName', key: '7', label: 'api_test.automation.creator'},
    {id: 'updateTime', key: '8', label: 'commons.update_time'},
    {id: 'description', key: '9', label: 'commons.description'},
  ],
