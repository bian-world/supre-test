export default {
  commons: {
    ...
    enterprise_edition_tips: "此功能为企业版功能，<a href='https://supretest.io/enterprise.html' target='_blank'>详情请咨询</a>",
  ...
  organization: {
    ...
    integration: {
      ...
      input_jira_url: '请输入Jira地址，例：https://supretest.atlassian.net/',
      ...
      use_tip_two: '保存 Basic Auth 账号信息后，需要在 SupreTest 项目中手动关联 ID/key 和缺陷模板',
  ...
  report: {
    ...
    export: '导出',
    export_to_ms_format: '导出 SupreTest 格式',
  ...
  api_test: {
    ...
    api_import: {
      ...
      tip: "说明",
      export_tip: "导出方法",
      ms_tip: "支持 SupreTest json 格式",
      ms_export_tip: "通过 SupreTest 接口测试页面或者浏览器插件导出 json 格式文件",
      ...
      ms_env_import_file_limit: "仅支持通过SupreTest导出的json格式文件",
    ...
    home_page: {
      ...
      test_case_details_card: {
        ...
        this_week_add_tab: "本周新增:{0}个&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp",
        this_week_execute_sm_tab: "本周执行: {0}次&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp",
        executed_sm_tab: "历史总执行: {0}次&nbsp&nbsp&nbsp&nbsp",
  ...
  dashboard:{
    dashboard: '数据概览',
    test_plan_progress:'测试进度',
    test_case_count:'用例数量统计',
    api_case_count:'接口用例数量统计',
    case_increased:'用例撰写情况',
    bug_list:'待修复bug统计',
    bug_duration: 'bug待修复时长'
  },
  test_track: {
    ...
    report: {
      ...
      overview: "概览",
      testing_time: "测试时间",
      testing_start_time:"测试开始时间",
      testing_end_time:"测试结束时间",
  ...
  ui: {
    ...
    selenium_export_tip: "通过 SupreTest 导出 side 文件",
    elementObject: "元素对象",
    elementLocator: "元素定位",
    elementType: "所属分类",
    not_selected: "(未选择元素)",
