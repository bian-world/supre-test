export default {
  ...
  organization: {
    ...
    integration: {
      ...
      use_tip_two: '保存 Basic Auth 賬號信息後，需要在 SupreTest 項目中手動關聯 ID/key 和缺陷模板',
  ...
  report: {
    ...
    export: '導出',
    export_to_ms_format: '導出 SupreTest 格式',
  ...
  api_test: {
    ...
    api_import: {
      ...
      ms_export_tip: "通過 SupreTest 接口測試頁面或者瀏覽器插件導出 json 格式文件",
      ...
      ms_env_import_file_limit: "僅支持通過SupreTest導出的json格式文件",
