export default {
  commons: {
    ...
    enterprise_edition_tips: "This is an enterprise edition feature, <a href='https://supretest.io/enterprise.html' target='_blank'>please consult for details</a>",
  ...
  organization: {
    ...
    integration: {
      ...
      input_jira_url: 'Please enter Jira address, for example: https://supretest.atlassian.net/',
      ...
      use_tip_two: 'After saving the Basic Auth account information, you need to manually associate the ID/key and issue template in the SupreTest project',
  ...
  report: {
    ...
    export: 'Export',
    export_to_ms_format: 'Export to SupreTest format',
  ...
  api_test: {
    ...
    api_import: {
      ...
      ms_tip: "Support for SupreTest JSON format",
      support_format: "Support p12, jks, pfx format",
      ms_export_tip: "Export jSON-formatted files via SupreTest website or browser plug-ins",
      ...
      ms_env_import_file_limit: "It only supports JSON format files exported through supretest",
