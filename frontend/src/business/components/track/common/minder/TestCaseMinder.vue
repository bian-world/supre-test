...
import {getCurrentSubProjectID, getNodePath, getUUID, hasPermission} from "@/common/js/utils";
...
name: "TestCaseMinder",
  ...
  methods: {
    ...
    getParam() {
      ...
      if(subProjectId){
        request = {...request,subProjectId:subProjectId}
      }
      return {request:{...request}, result: this.result, isDisable: false}
    },
    ...
    save() {
      ...
      let param = {
        projectId: this.projectId,
        subProjectId: getCurrentSubProjectID(),
        data: this.saveCases,
