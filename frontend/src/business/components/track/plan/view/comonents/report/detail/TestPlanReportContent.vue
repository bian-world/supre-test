...
<!--                                  v-if="!isTemplate && !isShare"/>-->
        ...
        <el-row class="center">
          <el-col :span="1" >
            <el-tag effect="dark" >{{$t('i18n.report')}}</el-tag>
          </el-col>
          <el-col :span="23" style="margin-left: 5px">
        <el-tabs >

        <el-tab-pane  :label="report.projectName" name="first" ></el-tab-pane>
        </el-tabs>
          </el-col>
        </el-row><br/><br/>
        <test-plan-overview-report v-if="overviewEnable" :report="report" :is-pdf="isPdf"/>
        <test-plan-summary-report v-if="summaryEnable" :is-db="isDb" :is-template="isTemplate" :is-share="isShare" :report="report" :plan-id="planId" :is-pdf="isPdf"/>
        <test-plan-functional-report v-if="functionalEnable" :is-db="isDb" :share-id="shareId" :is-share="isShare" :is-template="isTemplate" :plan-id="planId" :report="report" :is-pdf="isPdf"/>
        <test-plan-api-report v-if="apiEnable" :is-db="isDb" :share-id="shareId" :is-share="isShare" :is-template="isTemplate" :report="report" :plan-id="planId" :is-pdf="isPdf"/>
...
/deep/ .el-tag {
  box-shadow: -7px 7px 1px 0px #a1bfef;
  border-radius:0px;
  width:80px;
  height:30px;
