...
<!--            <el-form-item :label="$t('test_track.review.review_follow_people')" :label-width="formLabelWidth"
        ...
        <el-row>
          <el-col :span="20">
          <el-form-item label="所属项目" prop="subProject"  :label-width="formLabelWidth" >
...
import {getCurrentProjectID, getCurrentSubProjectID, listenGoBack, removeGoBackListener} from "@/common/js/utils";
...
export default {
  ...
  methods: {
    getSubProjectsByProjectId(){
      ...
      if(subProjectId && !this.form.subProjectId){
        this.form.subProjectId = subProjectId;
      }
