<template>
  <el-tabs class="other-info-tabs" v-loading="result.loading" v-model="tabActiveName">
    ...
    <el-tab-pane :label="$t('test_track.case.relate_test')" name="relateTest" :disabled=true>
      <test-case-test-relate :read-only="readOnly" :case-id="caseId" :version-enable="versionEnable" ref="relateTest"/>
    </el-tab-pane>

    <el-tab-pane :label="$t('test_track.related_requirements')" name="demand" :disabled=true>
      <el-col :span="8">
    ...
    <el-tab-pane :label="$t('test_track.case.relate_issue')" name="bug" :disabled="true">
    ...
    <el-tab-pane :label="$t('commons.relationship.name')" name="relationship" :disabled="true">
