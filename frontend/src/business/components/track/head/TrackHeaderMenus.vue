...
<!--          <el-menu-item :index="'/plan/all'" v-permission="['PROJECT_TRACK_PLAN:READ']"-->
<!--                        popper-class="submenu">-->
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      // if (path.indexOf("/plan/view") >= 0) {
      //   this.testPlanViewPath = path;
      //   this.reload();
      // }
      if (path.indexOf("/case/edit") >= 0) {
        this.testCaseEditPath = path;
        this.reload();
      }
      if (path.indexOf("/review/view") >= 0) {
