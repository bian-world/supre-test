...
/deep/ .nav-bar .zoom-in .icon{
  background-position:0px -113px;
}

/deep/ .nav-bar .zoom-out .icon{
  background-position:0px -91px;
}

/deep/ .nav-bar .hand .icon{
  background-position:0px -66px;
}

/deep/ .nav-bar .camera .icon{
  background-position:0px -44px;
}

/deep/ .nav-bar .nav-trigger .icon{
  background-position:0px -22px;
}

/deep/ .nav-btn .icon{
background: url("../../../../assets/iconss.png");
}

/deep/ .nav-bar .nav-btn .icon {
  width: 22px;
  height: 22px;
  margin: 35px auto;
  display: block;
...
/deep/ .nav-bar .zoom-pan {
  width: 3px;
  height: 120px;
  box-shadow: 0 0px #e50000;
  position: relative;
  background: #B9BBBF;
...
/deep/ .nav-bar .zoom-pan .indicator {
  background: #1e90ff;
  margin-top: 14px
}
</style>
