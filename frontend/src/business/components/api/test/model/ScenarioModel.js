...
export const BODY_FILE_DIR = "/opt/supretest/data/body"; //存放body文件上传目录
...
export class RequestFactory {
  ...
  constructor(options = {}) {
    ...
    switch (options.type) {
      ...
      case RequestFactory.TYPES.UI:
        return new UIOperator(options);
      default:
...
export class UIOperator extends Request {

  constructor(options = {}) {
    super(RequestFactory.TYPES.UI, options);
