...
import UiAutomationComponent from "@/business/components/ui/uiautomation/UiAutomationComponent";
  ...
  methods: {
    getComponent(type) {
      ...
      if (type === ELEMENT_TYPE.JDBCPreProcessor) {
        ...
        console.log("this.node %o", this.node)
        if(!this.node.checked){return }
