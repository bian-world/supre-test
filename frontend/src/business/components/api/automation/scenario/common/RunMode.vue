<template>
  ...
  >
    <div style="margin-bottom: 10px;" v-if="request.scenarioType !== 'UI'" >
    ...
    <div>
      ...
      <el-radio-group v-model="runConfig.mode" @change="changeMode">
        ...
        <el-radio  :disabled ="request.scenarioType == 'UI'" label="parallel">{{ $t("run_mode.parallel") }}</el-radio>
      </el-radio-group>
    </div>
        ...
        <el-col :span="18">
          <div>
            <el-radio-group v-model="runConfig.reportType">
              ...
              <el-radio  :disabled ="request.scenarioType == 'UI'" label="setReport">{{ $t("run_mode.set_report") }}</el-radio>
            </el-radio-group>
          </div>
          <div style="padding-top: 10px">
            <el-checkbox :disabled="request.scenarioType == 'UI'" v-model="runConfig.runWithinResourcePool" style="padding-right: 10px;">
