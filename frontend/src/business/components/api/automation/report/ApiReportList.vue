...
export default {
  ...
  methods: {
    search() {
      ...
      this.condition.isUi = this.route === 'ui';

      let url = ''

      if(this.trashActiveDom==='left' || this.route === 'ui'){
        this.reportTypeFilters = this.route==='ui'? this.reportUIScenarioFilters: this.reportScenarioFilters;
