...
export class WebDriverSampler extends DefaultTestElement {
  constructor(testName, options = {}) {
    super('WebDriverSampler', 'com.googlecode.jmeter.plugins.webdriver.sampler.gui.WebDriverSamplerGui', 'com.googlecode.jmeter.plugins.webdriver.sampler.WebDriverSampler', testName);

    this.stringProp("WebDriverSampler.script", options.script);
    this.stringProp("WebDriverSampler.parameters", options.parameters);
    this.stringProp("WebDriverSampler.language", options.language);
  }
}
