...
import {downloadFile, getCurrentProjectID, getCurrentSubProjectID, hasLicense} from "@/common/js/utils";
    ...
    exportApi(type, nodeTree) {
      ...
      this.result = this.$post("/api/definition/export/" + type, param, response => {
        ...
        if (type == 'SUPRETEST') {
          ...
          downloadFile("Supretest_Api_" + this.projectName + ".json", JSON.stringify(obj));
        } else {
