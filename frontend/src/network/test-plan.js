...
export function publishPlanModule(planId, moduleId,callback) {
  return planId && moduleId ? basePost('/test/plan/publish/module/' + planId + '/' + moduleId, callback) : {};
}

export function unPublishPlanModule(planId, moduleId,callback) {
  return planId && moduleId ? basePost('/test/plan/unPublish/module/' + planId + '/' + moduleId, callback) : {};
}
