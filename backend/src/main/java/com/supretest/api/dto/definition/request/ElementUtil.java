package com.supretest.api.dto.definition.request;
...
import com.supretest.api.dto.definition.request.controller.MsLoopController;
...
import com.supretest.commons.constants.DelimiterConstants;
import com.supretest.commons.constants.LoopConstants;
...
public class ElementUtil {
    ...
    public final static HashMap<String, String> clazzMap = new HashMap<String, String>() {
        {
            put("scenario", "com.supretest.api.dto.definition.request.MsScenario");
            put("HTTPSamplerProxy", "com.supretest.api.dto.definition.request.sampler.MsHTTPSamplerProxy");
            put("WebDriverSampler", "com.supretest.api.dto.definition.request.sampler.StWebDriverSampler");
            put("DubboSampler", "com.supretest.api.dto.definition.request.sampler.MsDubboSampler");
            put("JDBCSampler", "com.supretest.api.dto.definition.request.sampler.MsJDBCSampler");
            put("TCPSampler", "com.supretest.api.dto.definition.request.sampler.MsTCPSampler");
            put("IfController", "com.supretest.api.dto.definition.request.controller.MsIfController");
            put("TransactionController", "com.supretest.api.dto.definition.request.controller.MsTransactionController");
            put("LoopController", "com.supretest.api.dto.definition.request.controller.MsLoopController");
            put("ConstantTimer", "com.supretest.api.dto.definition.request.timer.MsConstantTimer");
            put("JSR223Processor", "com.supretest.api.dto.definition.request.processors.MsJSR223Processor");
            put("JSR223PreProcessor", "com.supretest.api.dto.definition.request.processors.pre.MsJSR223PreProcessor");
            put("JSR223PostProcessor", "com.supretest.api.dto.definition.request.processors.post.MsJSR223PostProcessor");
            put("JDBCPreProcessor", "com.supretest.api.dto.definition.request.processors.pre.MsJDBCPreProcessor");
            put("JDBCPostProcessor", "com.supretest.api.dto.definition.request.processors.post.MsJDBCPostProcessor");
            put("Assertions", "com.supretest.api.dto.definition.request.assertions.MsAssertions");
            put("Extract", "com.supretest.api.dto.definition.request.extract.MsExtract");
            put("JmeterElement", "com.supretest.api.dto.definition.request.unknown.MsJmeterElement");
            put("TestPlan", "com.supretest.api.dto.definition.request.MsTestPlan");
            put("ThreadGroup", "com.supretest.api.dto.definition.request.MsThreadGroup");
            put("DNSCacheManager", "com.supretest.api.dto.definition.request.dns.MsDNSCacheManager");
            put("DebugSampler", "com.supretest.api.dto.definition.request.sampler.MsDebugSampler");
            put("AuthManager", "com.supretest.api.dto.definition.request.auth.MsAuthManager");
        }
    };
