...
import com.supretest.api.dto.ApiCaseRunRequest;
import com.supretest.api.dto.DeleteCheckResult;
import com.supretest.api.dto.definition.*;
import com.supretest.api.exec.api.ApiCaseExecuteService;
...
public class ApiTestCaseController {
    ...
    public List<ApiTestCaseDTO> list(@PathVariable String projectId, @PathVariable String subProjectId) {
        ApiTestCaseRequest request = new ApiTestCaseRequest();
