...
import com.supretest.api.service.EsbApiParamService;
import com.supretest.api.service.EsbImportService;
...
import com.supretest.commons.json.JSONSchemaGenerator;
...
public class ApiDefinitionController {
    ...
    public List<SwaggerTaskResult> getSwaggerScheduleList(@PathVariable String projectId) {
        return this.getSwaggerScheduleList(projectId, null);
    }

    //查找定时任务列表
    @GetMapping("/scheduleTask/{projectId}/{subProjectId}")
    public List<SwaggerTaskResult> getSwaggerScheduleList(@PathVariable String projectId, @PathVariable String subProjectId) {
        return apiDefinitionService.getSwaggerScheduleList(projectId, subProjectId);
    }
