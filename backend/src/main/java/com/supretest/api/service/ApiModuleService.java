...
import com.supretest.base.mapper.ext.ExtApiDefinitionMapper;
import com.supretest.base.mapper.ext.ExtApiModuleMapper;
...
public class ApiModuleService extends NodeTreeService<ApiModuleDTO> {
    ...
    public List<ApiModuleDTO> getNodeTreeByProjectId(String projectId, String subProjectId, String protocol, String versionId) {
