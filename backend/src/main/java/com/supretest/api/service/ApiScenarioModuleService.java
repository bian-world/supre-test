...
import com.supretest.base.mapper.ext.ExtApiScenarioModuleMapper;
...
public class ApiScenarioModuleService extends NodeTreeService<ApiScenarioModuleDTO> {
    ...
    public List<ApiScenarioModuleDTO> getNodeTreeByProjectId(String projectId, String subProjectId) {
