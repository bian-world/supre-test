...
import com.supretest.api.dto.ApiCaseEditRequest;
import com.supretest.api.dto.DeleteCheckResult;
import com.supretest.api.dto.JmxInfoDTO;
...
public class ApiTestCaseService {
    ...
    public List<String> selectIdsNotExistsInPlan(String projectId, String subProjectId, String planId) {
        return extApiTestCaseMapper.selectIdsNotExistsInPlan(projectId, subProjectId, planId);
    }
    ...
    public List<ApiDataCountResult> countProtocolByProjectID(String projectId, String subProjectId) {
        return extApiTestCaseMapper.countProtocolByProjectID(projectId, subProjectId);
    }
    ...
    public long countByProjectIDAndCreateInThisWeek(String projectId, String subProjectId) {
        ...
        if (firstTime == null || lastTime == null) {
            ...
            return extApiTestCaseMapper.countByProjectIDAndCreateInThisWeek(projectId, subProjectId, firstTime.getTime(), lastTime.getTime());
        }
    }
    ...
    public void updateByApiDefinitionId(List<String> ids, String path, String method, String protocol, String subProjectId) {
        if ((StringUtils.isNotEmpty(method) || StringUtils.isNotEmpty(path) && RequestType.HTTP.equals(protocol))) {
            ...
            bloBs.forEach(apiTestCase -> {
                ...
                String requestStr = JSON.toJSONString(req);
                apiTestCase.setRequest(requestStr);
                apiTestCase.setSubProjectId(subProjectId);
                batchMapper.updateByPrimaryKeySelective(apiTestCase);
            });
            sqlSession.flushStatements();
            if (sqlSession != null && sqlSessionFactory != null) {
