...
import com.supretest.api.jmeter.FixedCapacityUtils;
import com.supretest.base.domain.*;
import com.supretest.base.mapper.*;
import com.supretest.base.mapper.ext.ExtApiScenarioReportMapper;
...
public class ApiScenarioReportService {
    ...
    public void margeReport(String reportId, String runMode) {
        ...
        // 更新控制台信息
        apiScenarioReportStructureService.update(reportId, FixedCapacityUtils.getJmeterLogger(reportId, true));
    }
...
//        }
    ...
    public long countByProjectIdAndCreateAndByScheduleInThisWeek(String projectId, String subProjectId) {
        ...
        if (firstTime == null || lastTime == null) {
            ...
            return extApiScenarioReportMapper.countByProjectIdAndCreateAndByScheduleInThisWeek(projectId, subProjectId, firstTime.getTime(), lastTime.getTime());
        }
    }
    ...
    public List<ApiDataCountResult> countByProjectIdGroupByExecuteResult(String projectId, String subProjectId) {
        return extApiScenarioReportMapper.countByProjectIdGroupByExecuteResult(projectId, subProjectId);
    }
