...
import com.supretest.api.parse.old.ApiImportParser;
import com.supretest.api.parse.old.ApiImportParserFactory;
import com.supretest.api.parse.old.JmeterDocumentParser;
import com.supretest.base.domain.*;
import com.supretest.base.mapper.ApiTestFileMapper;
import com.supretest.base.mapper.ApiTestMapper;
import com.supretest.base.mapper.ext.ExtApiTestMapper;
...
import com.supretest.job.sechedule.ApiTestJob;
import com.supretest.performance.parse.EngineSourceParserFactory;
...
public class APITestService {
    ...
    private static final String BODY_FILE_DIR = "/opt/supretest/data/body";
    ...
    public List<ApiTest> getApiTestByProjectId(String projectId, String subProjectId) {
        return extApiTestMapper.getApiTestByProjectId(projectId, subProjectId);
    }
