...
import com.supretest.api.dto.ApiScenarioReportBaseInfoDTO;
import com.supretest.api.dto.ApiScenarioReportDTO;
import com.supretest.api.dto.RequestResultExpandDTO;
import com.supretest.api.dto.StepTreeDTO;
import com.supretest.api.dto.definition.request.ElementUtil;
import com.supretest.api.exec.utils.ResultParseUtil;
import com.supretest.api.service.vo.ApiDefinitionExecResultVo;
import com.supretest.base.domain.*;
import com.supretest.base.mapper.*;
import com.supretest.base.mapper.ext.ExtApiScenarioReportResultMapper;
...
import com.supretest.commons.constants.CommandType;
        ...
        for (StepTreeDTO root : dtoList) {
            if (CollectionUtils.isNotEmpty(root.getChildren())) {
                ...
                for (StepTreeDTO step : root.getChildren()) {
                    if (StringUtils.equalsIgnoreCase(step.getTotalStatus(), "fail") ||
                            StringUtils.equalsIgnoreCase(step.getTotalStatus(), "Error")) {
