...
import com.supretest.track.request.testcase.TrackCount;
...
public class ApiDefinitionExecResultService {
    ...
    public long countByTestCaseIDInProjectAndExecutedInThisWeek(String projectId, String subProjectId) {
        ...
        if (firstTime == null || lastTime == null) {
            ...
            return extApiDefinitionExecResultMapper.countByProjectIDAndCreateInThisWeek(projectId, subProjectId, firstTime.getTime(), lastTime.getTime());
        }
    }

    public long countByTestCaseIDInProject(String projectId, String subProjectId) {
        return extApiDefinitionExecResultMapper.countByTestCaseIDInProject(projectId, subProjectId);

    }

    public List<ExecutedCaseInfoResult> findFailureCaseInfoByProjectIDAndLimitNumberInSevenDays(String projectId, String subProjectId, int limitNumber) {
        ...
        if (startTime == null) {
            ...
            List<ExecutedCaseInfoResult> list = extApiDefinitionExecResultMapper.findFaliureCaseInfoByProjectIDAndExecuteTimeAndLimitNumber(projectId, subProjectId, startTime.getTime());
