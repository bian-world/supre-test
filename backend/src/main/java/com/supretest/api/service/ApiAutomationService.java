...
import com.supretest.api.dto.automation.parse.ApiScenarioImportUtil;
import com.supretest.api.dto.automation.parse.ScenarioImport;
import com.supretest.api.dto.automation.parse.ScenarioImportParserFactory;
import com.supretest.api.dto.datacount.ApiDataCountResult;
import com.supretest.api.dto.definition.ApiTestCaseInfo;
...
import com.supretest.api.dto.definition.request.unknown.MsJmeterElement;
import com.supretest.api.exec.scenario.ApiScenarioEnvService;
import com.supretest.api.exec.scenario.ApiScenarioExecuteService;
...
import com.supretest.log.vo.api.AutomationReference;
...
import com.supretest.track.request.testplan.FileOperationRequest;
...
public class ApiAutomationService {
    ...
    public ApiScenario update(SaveApiScenarioRequest request, List<MultipartFile> bodyFiles, List<MultipartFile> scenarioFiles) {
        ...
        ApiScenarioExample example = new ApiScenarioExample();
        example.createCriteria().andIdEqualTo(scenario.getId());
...
//                .andVersionIdEqualTo(request.getVersionId());
    ...
    public long countScenarioByProjectID(String projectId, String subProjectId) {
        return extApiScenarioMapper.countByProjectID(projectId, subProjectId);
    }
    ...
    public List<ApiScenarioWithBLOBs> getSameScenario(ApiScenarioWithBLOBs request) {
        ...
        if(StringUtils.isNotEmpty(request.getSubProjectId())){
            criteria.andSubProjectIdEqualTo(request.getProjectId());
        }else{
            criteria.andSubProjectIdIsNull();
        }
    ...
    public ApiScenrioExportResult export(ApiScenarioBatchRequest request) {
        ...
        result.setVersion(System.getenv("VERSION"));
    ...
    public Map<String, List<String>> selectScenarioUseUrlByProjectId(String projectId, String subProjectId) {
        List<ApiScenarioReferenceId> list = apiScenarioReferenceIdService.selectUrlByProjectId(projectId, subProjectId);
