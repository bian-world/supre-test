...
public class FileUtils {
    public static final String BODY_FILE_DIR = "/opt/supretest/data/body";
    public static final String MD_IMAGE_DIR = "/opt/supretest/data/image/markdown";
    public static final String UI_IMAGE_DIR = "/opt/supretest/data/image/ui/screenshots";
    ...
    public static String createFile(MultipartFile bodyFile) {
        String dir = "/opt/supretest/data/body/tmp/";
