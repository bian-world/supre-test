...
import com.supretest.security.CustomSessionIdGenerator;
import com.supretest.security.CustomSessionManager;
...
public class ShiroUtils {
    ...
    public static void loadBaseFilterChain(Map<String, String> filterChainDefinitionMap) {
        ...
        filterChainDefinitionMap.put("/test/plan/case/list/all/*", "anon");
        filterChainDefinitionMap.put("/pdfPlanReport", "anon");
        filterChainDefinitionMap.put("/test/plan/report/*", "anon");
