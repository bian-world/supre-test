...
import com.supretest.api.dto.automation.ApiScenarioBatchRequest;
import com.supretest.api.dto.automation.ApiScenarioExportJmxDTO;
...
import com.supretest.base.mapper.ext.ExtLoadTestReportDetailMapper;
...
import com.supretest.job.sechedule.PerformanceTestJob;
...
import com.supretest.log.vo.performance.PerformanceReference;
import com.supretest.performance.base.GranularityData;
import com.supretest.performance.base.VumProcessedStatus;
import com.supretest.performance.dto.LoadModuleDTO;
import com.supretest.performance.dto.LoadTestBatchRequest;
...
import com.supretest.performance.request.*;
import com.supretest.service.ApiPerformanceService;
...
//            .andVersionIdEqualTo(request.getVersionId());
    ...
    public LoadTest edit(EditTestPlanRequest request, List<MultipartFile> files) {
        ...
        // 更新数据
        LoadTestExample example = new LoadTestExample();
        example.createCriteria().andIdEqualTo(loadTest.getId());
//        .andVersionIdEqualTo(request.getVersionId());
