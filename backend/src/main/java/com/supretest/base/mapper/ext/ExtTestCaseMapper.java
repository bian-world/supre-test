...
public interface ExtTestCaseMapper {
     ...
     * @return 统计结果
     */
    List<TrackCountResult> countPriority(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId);

    long countCreatedThisWeek(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId, @Param("firstDayTimestamp") long firstDayTimestamp, @Param("lastDayTimestamp") long lastDayTimestamp);

    List<TrackCountResult> countStatus(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId);

    List<TrackCountResult> countRelevance(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId);

    long countRelevanceCreatedThisWeek(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId, @Param("firstDayTimestamp") long firstDayTimestamp, @Param("lastDayTimestamp") long lastDayTimestamp);

    int countCoverage(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId);

    List<TrackCountResult> countFuncMaintainer(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId);

    List<TrackCountResult> countRelevanceMaintainer(@Param("projectId") String projectId, @Param("subProjectId") String subProjectId);
