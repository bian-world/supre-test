...
import com.supretest.base.mapper.ext.ExtIssuesMapper;
import com.supretest.base.mapper.ext.ExtProjectMapper;
import com.supretest.base.mapper.ext.ExtTestCaseNodeMapper;
import com.supretest.commons.constants.CustomFieldType;
import com.supretest.commons.constants.IssueRefType;
...
import com.supretest.track.issue.domain.ProjectIssueConfig;
...
public abstract class AbstractIssuePlatform implements IssuesPlatform {
    ...
    protected ExtProjectMapper extProjectMapper;
    protected ExtTestCaseNodeMapper extTestCaseNodeMapper;
    protected TestCaseNodeMapper testCaseNodeMapper;
    protected ZendaoBranchTreeMapper zendaoBranchTreeMapper;
    protected TestCaseNodeService testCaseNodeService;
    protected ModuleNode moduleNode;
    protected ApiModuleMapper apiModuleMapper;
    protected ApiModuleService apiModuleService;
    protected ApiScenarioModuleMapper apiScenarioModuleMapper;
    protected ApiScenarioModuleService apiScenarioModuleService;
    protected ZendaoProjectMapper zendaoProjectMapper;
    ...
    public AbstractIssuePlatform() {
        ...
        this.projectMapper = CommonBeanFactory.getBean(ProjectMapper.class);
        this.extProjectMapper = CommonBeanFactory.getBean(ExtProjectMapper.class);
        this.extTestCaseNodeMapper = CommonBeanFactory.getBean(ExtTestCaseNodeMapper.class);
        this.testCaseNodeMapper = CommonBeanFactory.getBean(TestCaseNodeMapper.class);
        this.zendaoBranchTreeMapper = CommonBeanFactory.getBean(ZendaoBranchTreeMapper.class);
        this.testCaseNodeService = CommonBeanFactory.getBean(TestCaseNodeService.class);
        this.moduleNode = CommonBeanFactory.getBean(ModuleNode.class);
        this.apiModuleMapper = CommonBeanFactory.getBean(ApiModuleMapper.class);
        this.apiScenarioModuleMapper = CommonBeanFactory.getBean(ApiScenarioModuleMapper.class);
        this.apiModuleService = CommonBeanFactory.getBean(ApiModuleService.class);
        this.apiScenarioModuleService = CommonBeanFactory.getBean(ApiScenarioModuleService.class);
        this.zendaoProjectMapper = CommonBeanFactory.getBean(ZendaoProjectMapper.class);
