...
import com.supretest.track.request.testplan.AddTestPlanRequest;
import com.supretest.track.request.testplan.TestplanRunRequest;
import com.supretest.track.request.testplancase.TestCaseRelevanceRequest;
...
public class TestPlanController {
    ...
    @PostMapping("/list/testPlanAll")
    @RequiresPermissions("PROJECT_TRACK_PLAN:READ")
    public List<TestPlanDTOWithMetric> listTestPlanAll(@RequestBody QueryTestPlanRequest request) {
    ...
    public List<TestPlanDTOWithMetric> listByProjectId(@PathVariable String projectId, @PathVariable String workspaceId) {
        return this.listByProjectId(projectId, null, workspaceId);
    }

    /*jenkins测试计划*/
    @GetMapping("/list/all/{projectId}/{subProjectId}/{workspaceId}")
    public List<TestPlanDTOWithMetric> listByProjectId(@PathVariable String projectId, @PathVariable String subProjectId, @PathVariable String workspaceId) {
...
//    @MsAuditLog(module = "track_test_plan", type = OperLogConstants.UPDATE, beforeEvent = "#msClass.getLogDetails(#planId)", content = "#msClass.getLogDetails(#planId)", msClass = TestPlanService.class)
    ...
    public void exportHtmlReport(@PathVariable String planId, @PathVariable(required = false) String lang, HttpServletResponse response) throws Exception {
        testPlanService.exportPlanReport(planId, lang, response);
    }
    @GetMapping("/report/exportPdf/{planId}/{lang}")
    public void exportPdfReport(@PathVariable String planId, @PathVariable(required = false) String lang, HttpServletResponse response) throws Exception {
        testPlanService.exportPlanPdfReport(planId,response);
    }
    ...
    @PostMapping(value = "/publish/module/{planId}/{moduleId}")
    public void publishModule(@PathVariable(required = true) String planId,@PathVariable(required = true) String moduleId) {
        testPlanService.publishModule(planId,moduleId,"add");
    }

    @PostMapping (value = "/unPublish/module/{planId}/{moduleId}")
    public void unPublishModule(@PathVariable(required = true) String planId,@PathVariable(required = true) String moduleId) {
        testPlanService.publishModule(planId,moduleId,"delete");
    }
