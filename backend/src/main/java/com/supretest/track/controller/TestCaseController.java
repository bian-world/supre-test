...
import com.supretest.dto.TestCaseTestDao;
...
public class TestCaseController {
    ...
    @RequiresPermissions("PROJECT_TRACK_CASE:READ")
    public List<TestCaseDTO> list(@PathVariable String projectId, @PathVariable String subProjectId) {
    ...
    public List<TestCaseDTO> listByMethod(@PathVariable String projectId) {
       return this.listByMethod(projectId, null);
    }

    /*jenkins项目下所有接口和性能测试用例*/
    @GetMapping("/list/method/{projectId}/{subProjectId}")
    public List<TestCaseDTO> listByMethod(@PathVariable String projectId, @PathVariable String subProjectId) {
        QueryTestCaseRequest request = new QueryTestCaseRequest();
        request.setProjectId(projectId);
