...
import com.supretest.base.mapper.IssueTemplateMapper;
import com.supretest.base.mapper.ext.ExtIssueTemplateMapper;
...
public class IssueTemplateService extends TemplateBaseService {
    ...
    private void createTemplateWithUpdateField(String projectId, CustomField customField) {
        ...
        issueTemplate.setPlatform(TemplateConstants.IssueTemplatePlatform.supretest.name());
