...
import com.supretest.base.mapper.ext.ExtWorkspaceMapper;
...
import com.supretest.commons.utils.CodingUtil;
...
import com.supretest.excel.domain.*;
import com.supretest.excel.listener.EasyExcelListener;
import com.supretest.excel.listener.UserDataListener;
...
import com.supretest.security.MsUserToken;
...
import static com.supretest.commons.constants.SessionConstants.ATTR_USER;
...
public class UserService {
    ...
    public List<User> getUserListWithRequest(com.supretest.controller.request.UserRequest request) {
    ...
    public boolean checkWhetherChangePasswordOrNot(LoginRequest request) {
        ...
        if (StringUtils.equals("admin", request.getUsername())) {
            ...
            example.createCriteria().andIdEqualTo("admin")
                    .andPasswordEqualTo(CodingUtil.md5("supretest"));
            return userMapper.countByExample(example) > 0;
        }
