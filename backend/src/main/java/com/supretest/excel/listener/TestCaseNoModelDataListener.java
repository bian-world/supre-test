package com.supretest.excel.listener;
...
import com.supretest.excel.annotation.NotRequired;
import com.supretest.excel.domain.ExcelErrData;
import com.supretest.excel.domain.TestCaseExcelData;
import com.supretest.excel.utils.ExcelValidateHelper;
...
//        }
    ...
    public String validate(TestCaseExcelData data, String errMsg) {
        ...
        if (request.getTestCaseNames().contains(data.getName())) {
            ...
            testCase.setSubProjectId(request.getSubProjectId());
